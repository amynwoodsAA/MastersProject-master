...
class EmptyMiniIntraDiagram extends React.Component{
    constructor(props){
        super(props);
        console.log("In consructor of EmptyMiniIntraDiagram");
        this.redrawChart= this.redrawChart.bind(this);
    }//end constructor

    componentDidMount(){
        console.log("In componenet did mount for EmptyMiniIntraDiagram");
        ...
        this.setState({width: width, height: height}, ()  => {
            this.drawEmptyMiniIntraDiagram();
        })
    ...
    componentWillUnmount(){
        console.log("Unmount EmptyMiniIntraDiagram")
    ...
    redrawChart(){
        console.log("redrawing empty mini intra diagram")
        ...
        this.drawEmptyMiniIntraDiagram = this.drawEmptyMiniIntraDiagram.bind(this);
        this.drawEmptyMiniIntraDiagram();
    }

    drawEmptyMiniIntraDiagram(){
        console.log("In drawEmptyMiniIntraDiagram");
    ...
    render(){
        console.log("Rendering for EmptyMiniIntraDiagram")
      
        return <div id={this.props.id} ref={this.chartRef} ></div>
    }
}

export default EmptyMiniIntraDiagram;