...
class EmptyMiniIcicleDiagram extends React.Component{
    constructor(props){
        super(props);
        console.log("In consructor of EmptyMiniIcicleDiagram");
        this.redrawChart= this.redrawChart.bind(this);
    }//end constructor

    componentDidMount(){
        console.log("In componenet did mount for EmptyMiniIcicleDiagram");
        ...
        this.setState({width: width, height: height}, ()  => {
            this.drawEmptyMiniIcicleDiagram();
        })
    ...
    componentWillUnmount(){
        console.log("Unmount EmptyMiniIcicleDiagram")
    ...
    redrawChart(){
        ...
        console.log("Redrawing empty mini icicle diagram")
        let width = this.getWidth()
        ...
        this.drawEmptyMiniIcicleDiagram = this.drawEmptyMiniIcicleDiagram.bind(this);
        this.drawEmptyMiniIcicleDiagram();
    }

    drawEmptyMiniIcicleDiagram(){
        console.log("In drawEmptyMiniIcicleDiagram");
    ...
    render(){
        console.log("Rendering for EmptyMiniIcicleDiagram")
      
        return <div id={this.props.id} ref={this.chartRef} ></div>
    }
}

export default EmptyMiniIcicleDiagram;